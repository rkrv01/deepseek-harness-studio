...
import pluginCenterRemote from '@deepseek-ai/dsh-host-plugin-center/remote'
...
export type {} from '@deepseek-ai/dsh-host-plugin-center/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      pluginInventoryRemote, pluginCenterRemote, messageFeedbackRemote, sessionReferencesRemote,
    ]) {
