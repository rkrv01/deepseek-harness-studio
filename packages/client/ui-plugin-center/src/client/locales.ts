...
export const zh = {
  ...
  discoveryNav: '插件发现',
  discoveryTitle: '插件发现',
  discoveryIntro: '每天发现值得安装的 Starlight AI助手插件',
  ...
  installReleaseGated: '安装与卸载只在 Starlight AI助手 Desktop 中可用。',
  ...
  applicationIntro: '发现并启动由星光集成的完整 AI 应用。应用拥有独立界面、数据与运行流程。',
  applicationSources: '应用来源',
  applicationOfficial: '星光',
  applicationOfficialHint: '由星光团队内置维护的完整应用。',
  ...
  presetIntro: '发现星光工作流与社区 Agent Preset，一键安装后用于新会话',
  ...
  presetFufanOfficialTitle: '星光',
  presetFufanOfficialHint: '由星光团队维护的七套内置工作流。',
  presetFufanOfficialBadge: '星光',
  presetFufanOfficialPackage: '内置能力包 · 安装后可删除',
  presetFufanOfficialDisclaimer: '由星光团队维护并随应用发布。',
  ...
  presetRuntimeConfirmDetail: '将从固定软件源下载已锁定版本，安装到 Starlight AI助手的专属本机目录；不会修改系统级软件，耗时取决于网络。',
...
export const en = {
  ...
  discoveryIntro: 'Find Starlight AI助手 plugins worth installing every day.',
  ...
  installReleaseGated: 'Install and uninstall are available only in Starlight AI助手 Desktop.',
  ...
  applicationOfficialHint: 'Complete applications maintained and shipped by the Fufan Desktop team; not official Starlight AI助手 content.',
  ...
  presetFufanOfficialDisclaimer: 'Maintained and shipped by the Fufan Desktop team; not official Starlight AI助手 content.',
  ...
  presetRuntimeConfirmDetail: 'Pinned versions will be downloaded from fixed registries into the Starlight AI助手 app-owned directory. System software is not modified; timing depends on the network.',
