...
export const zh = {
  ...
  'placeholder.default': '给智能体发消息，可支持拖拽上传文件',
  'placeholder.unavailable': '会话不可用',
  'placeholder.parentOffline': '父会话已离线，无法继续发送；仍可停止当前运行',
  'placeholder.hero': '描述你想要构建的内容，可支持拖拽上传文件',
  'placeholder.workspace': '选择一个工作区开始',
  'document.remove': '移除文件 {name}',
  'document.unnamed': '未命名文件',
  'input.commands': '命令',
  'input.uploadFile': '上传文件',
  'input.unsupportedFile': '暂不支持该文件格式',
  'input.stop': '停止生成',
  'input.send': '发送消息',
  'input.clear': '清空输入',
  'demo.placeholder': '当前为演示版本，请选择上方场景应用方式使用。',
  'demo.internalModel': '企业内部模型',
  'demo.lockedToast': '当前演示版本不可使用',
  ...
  'access.menu.title': '应如何批准 Starlight AI助手操作？',
  ...
  'hero.headline.demo': 'Starlight 应用平台 AI 服务底座',
  'hero.preview': '预览版',
...
export const en = {
  ...
  'placeholder.default': 'Message the agent — drag files here to attach',
  ...
  'placeholder.hero': 'Describe what you want to build — drag files here to attach',
  'placeholder.workspace': 'Choose a workspace to start',
  'document.remove': 'Remove file {name}',
  'document.unnamed': 'Unnamed file',
  'input.commands': 'Commands',
  'input.uploadFile': 'Upload files',
  'input.unsupportedFile': 'That file format is not supported yet',
  'input.stop': 'Stop generating',
  'input.send': 'Send message',
  'input.clear': 'Clear input',
  'demo.placeholder': 'This is the demo version. Please choose a scenario above to get started.',
  'demo.internalModel': 'Enterprise Internal Model',
  'demo.lockedToast': 'Not available in this demo version',
  ...
  'access.menu.title': 'How should Starlight AI助手 actions be approved?',
  ...
  'image.dropTitle.mixed': 'Drag images or files here to add them',
  'image.dropDesc.mixed': 'Up to {count} images, {size} each; documents support txt / Markdown / Word / Excel / PDF',
  ...
  'hero.headline.demo': 'Starlight Application Platform AI Service',
